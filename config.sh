...
GRUB_SUPERUSER="grub_admin"  # The GRUB superuser name (standard: grub_admin).
GRUB_PASSWORD="your_strong_grub_password" # A strong password to protect the GRUB boot menu.
